...
states = ['Andhra Pradesh', 'Hyderabad', 'Arunachal Pradesh', 'Itanagar', 'Assam', 'Dispur', 'Bihar', 'Patna', 'Chhattisgarh', 'Raipur',\
    ...
    'Bangalore', 'Kerala', 'Thiruvananthapuram', 'Madhya Pradesh', 'Bhopal', 'Maharashtra', 'Mumbai', 'Manipur', 'Imphal', 'Meghalaya',\
    'Shillong', 'Mizoram', 'Aizawl', 'Nagaland', 'Kohima', 'Odisha', 'Bhubaneshwar', 'Punjab', 'Chandigarh', 'Rajasthan', 'Jaipur', 'Sikkim',\
    'Gangtok', 'Tamil Nadu', 'Chennai', 'Telangana', 'Hyderabad','Tripura', 'Agartala', 'Uttarakhand', 'Dehradun', 'Uttar Pradesh', 'Lucknow',\
    'West Bengal', 'Kolkata', 'Andaman and Nicobar Islands', 'Port Blair', 'Chandigarh', 'Dadra and Nagar Haveli',' Daman & Diu',\
    'The Government of NCT of Delhi', 'Delhi', 'Jammu & Kashmir', 'Srinagar', 'Jammu', 'Ladakh', 'Leh', 'Lakshadweep', 'Kavaratti', 'Puducherry', 'Puducherry']
...
def home(request):
    if request.method == 'POST':
        ...
        passport = PassportImage(name= mrz_data['names'], passport_img = request.FILES['passport'])
        passport.save()
